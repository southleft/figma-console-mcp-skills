...
## Skill boundaries
- **Plugin API rules** (return pattern, async getters, `loadFontAsync`, layoutSizing-after-append) →
  load the official [`figma-use`](https://www.figma.com/community/skills) skill first.
